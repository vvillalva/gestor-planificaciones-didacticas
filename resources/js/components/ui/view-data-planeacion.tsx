    ...
    return (
        <Sheet>
            ...
            <SheetContent className="flex flex-col gap-4">
                ...
                <div className="flex flex-col">
                    <Label className="text-neutral-600">Comentarios</Label>
                    <p className="font-medium text-[20px] whitespace-normal break-words">{planeacion?.comentario || 'No hay comentarios disponibles.'}</p>
                </div>
                <SheetFooter>
                    <SheetClose asChild>
